...
class TopRatedDescription extends StatelessWidget {
  final String name, description, bannerurl, posterurl, vote, release_date, total_votes;
  const TopRatedDescription(
      {Key? key,
        ...
        required this.vote,
        required this.release_date, required this.total_votes})
      : super(key: key);
        ...
        child: ListView(
          children: [
            ...
            Container(
              ...
              child: modified_text(text: 'Releasing on - '+release_date, size: 14,),
            ),
            Row(
              children: [
                Container(
